const e={props:{api_key:"Ключ API",offer_id:"ID оффера",stream_code:"ID потока",country:"Страна"},subs:{sub1:"sub_id_1",sub2:"sub_id_2",sub3:"sub_id_3",sub4:"sub_id_4"},template:`
    $request_params = [
