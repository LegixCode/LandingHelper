const a={props:{api_key:"Ключ API",stream_id:"ID потока",country:"Страна"},subs:{data1:"sub_id_1",data2:"sub_id_2",data3:"sub_id_3",data4:"sub_id_4",data5:"sub_id_5"},template:`
    $request_params = [
